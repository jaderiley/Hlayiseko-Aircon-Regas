...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Hlayiseko aircon regas",
    phone:     "+27 83 550 7360",
    whatsapp:  "+27 83 550 7360",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Hlayiseko aircon regas — Aircon & hvac in germiston",
    description: "Hlayiseko aircon regas provides professional aircon & HVAC in Germiston. 4 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Aircon & HVAC · Germiston & surrounds",
    heroTitle:  "Stay cool, stay comfortable — <em>aircon done right.</em>",
    heroLead:   "Hlayiseko aircon regas installs, repairs and services air conditioning and HVAC systems for homes and businesses across Germiston and the surrounding suburbs.",
    ...
    band: {
      ...
      alt:   "Hlayiseko aircon regas team at work in Germiston",
      text:  "Keep your home or office comfortable all year round."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Germiston. Serving the surrounding area.",
    areasLead:  "We cover Germiston, Johannesburg, Randburg and the wider region for installations, repairs and servicing.",
